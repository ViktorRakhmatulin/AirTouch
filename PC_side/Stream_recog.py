...
try:
    while True:
        ...
        opencvImage = cv2.cvtColor(numpy.array(image), cv2.COLOR_RGB2GRAY)
            #Aprilshit
#        gray = cv2.cvtColor(opencvImage,cv2.COLOR_BGR2GRAY)
        #cv2.imshow("gray", gray)
        results = detector.detect(opencvImage, estimate_tag_pose=True, camera_params=(4.9989302084566577e+02, 5.0320386297363052e+02, 3.2668799142880744e+02, 2.3439979484610001e+02), tag_size=0.0375)
